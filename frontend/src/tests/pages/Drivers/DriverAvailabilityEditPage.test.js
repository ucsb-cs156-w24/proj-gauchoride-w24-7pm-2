...
describe("DriverAvailabilityEditPage tests", () => {
    ...
    describe("when the backend doesn't return a todo", () => {
        ...
        test("renders header but table is not present", async () => {
            ...
            expect(queryByTestId("DriverAvailabilityForm-driverId")).not.toBeInTheDocument();
            restoreConsole();
        });
    });
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(startTimeField, { target: { value: '3:31PM' } })
            fireEvent.change(endTimeField, { target: { value: '4:46PM' } })
